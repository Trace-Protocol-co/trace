...
function buildAcceptsEntry(req) {
    return {
        scheme: X402.scheme,
...
export function buildChallenge(req, error = "X-PAYMENT header is required") {
    return {
...
function paymentRequiredHeader(challenge) {
 ...
 * business validation.
 */
export function sendChallenge(req, res, error) {
